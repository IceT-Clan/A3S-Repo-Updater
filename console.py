...
class Output:
    ...
    def printerrstate(self, state, kwargs):
    ...
    def printstatus(self, state, **kwargs):
        ...
        if state == "updating":
            ...
            self.printerrstate(state, kwargs)
        else:
